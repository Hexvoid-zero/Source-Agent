...
- **Dynamic Search Intent Detection**: Automatically detects if the task involves searching (e.g. `"search for Y"` in X) and dynamically instructs the vision model to target the app's search bar/input box rather than a chat input field.
